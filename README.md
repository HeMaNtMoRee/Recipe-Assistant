...
|
|__ frontend/
|   |__ index.html           Main HTML file with chat, upload, and search views
|   |__ style.css            Complete CSS with dark theme and animations
|   |__ script.js            Frontend logic for streaming chat, uploads, and search
|
|__ data/
...
The frontend is served as static files by FastAPI, so no separate web server is needed.
